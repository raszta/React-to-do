...
//updating choosen item
    updateToDo = () => { 
        ...
        axios.put(`${this.apiUrl}/${update.id}`, { activity: this.state.newToDo})
        .then(response => { toDo[this.state.editingIndex] = response.data;
            this.setState({
                editing: false,
                toDo: toDo,
                newToDo: '',                
...
//deleting all of items from data
    ...
    //         .then(response=>{
    //             toDo[toDo.indexOf(el.id)] = response.data;
           ...
           <Header 
            ...
            <div className="row">
                <div className="col">
                    ...
                    {
                        this.state.notificationMsg && //if true show alert
                    ...
                    }             
                    {
                        ...
                        {/* <button className="btn btn-warning ml-3 btn-sm app__btn" onClick={this.allDone} disabled={this.state.toDo.length > 0 ? false : true}>
                        All  done
                        </button>       */}
